...
function (_React$Component) {
  ...
  function MultiRowSelectableTable(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MultiRowSelectableTable).call(this, props));
    _this.state = {
  ...
  _createClass(MultiRowSelectableTable, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h3", {
        id: "selected-indexes"
      }, "Selected Items:", ' ', this.state.selectedIndexes), _react.default.createElement("h3", {
        id: "last-selected-index"
      }, "Last Selected Item:", ' ', this.state.lastSelectedIndex), _react.default.createElement(_Table.default, {
        isStriped: false
        ...
        key: "PHONE_NUMBER",
        minWidth: "large"
      })), _react.default.createElement(_Table.default.MultiSelectableRows, {
...
var _default = MultiRowSelectableTable;
