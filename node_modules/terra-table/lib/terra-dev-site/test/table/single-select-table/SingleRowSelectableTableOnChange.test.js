...
function (_React$Component) {
  ...
  function SingleRowSelectableTable(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SingleRowSelectableTable).call(this, props));
    _this.state = {
      selectedIndex: null
    };
  ...
  _createClass(SingleRowSelectableTable, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        key: "PHONE_NUMBER",
        minWidth: "large"
      })), _react.default.createElement(_Table.default.SingleSelectableRows, {
