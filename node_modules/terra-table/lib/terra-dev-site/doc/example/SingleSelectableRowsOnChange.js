...
var onChange = function onChange(event, selectedIndex) {
  ...
  alert("Selected indexes changed. Selected index: ".concat(selectedIndex));
};

var SingleSelectableRowsOnChange = function SingleSelectableRowsOnChange() {
...
var _default = SingleSelectableRowsOnChange;
