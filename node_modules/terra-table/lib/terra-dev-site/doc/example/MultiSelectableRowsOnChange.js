...
var onChange = function onChange(event, selectedIndexes, newIndex) {
  ...
  alert("Selected indexes changed. Newly changed index: ".concat(newIndex, ". Selected indexes: ").concat(selectedIndexes));
};
...
var _default = MultiSelectableRowsDisableUnselectedRows;
