...
function (_React$Component) {
  ...
  function RowsOnClick() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RowsOnClick).call(this));
    _this.onClicked = _this.onClicked.bind(_assertThisInitialized(_this));
  ...
  _createClass(RowsOnClick, [{
    ...
    value: function render() {
      return _react.default.createElement(_Table.default, {
        ...
        key: "PHONE_NUMBER",
        minWidth: "large"
      })), _react.default.createElement(_Table.default.Rows, {
