...
function (_React$Component) {
  ...
  function SingleSelectableRows(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SingleSelectableRows).call(this, props));
    _this.handleOnChange = _this.handleOnChange.bind(_assertThisInitialized(_this));
    _this.state = {
      selectedIndex: _SelectableTableRows.default.Utils.initialSingleSelectRowIndex(_this.props.children)
    };
    return _this;
  }
  ...
  _createClass(SingleSelectableRows, [{
    ...
    value: function handleOnChange(event, index) {
      ...
      if (_SelectableTableRows.default.Utils.shouldHandleSingleSelectRowSelection(this.state.selectedIndex, index)) {
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          customProps = _objectWithoutProperties(_this$props, ["children", "onChange"]);
...
SingleSelectableRows.Row = _SelectableTableRows.default.Row;
var _default = SingleSelectableRows;
