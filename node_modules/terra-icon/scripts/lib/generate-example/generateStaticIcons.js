...
/* eslint-disable */
var outputfile = _fs.default.createWriteStream('../../packages/terra-icon/src/terra-dev-site/doc/example/IconStatic.jsx', {
  flags: 'w'
});
...
var generateIconAll = function generateIconAll(iconObjs) {
  return new Promise(function (resolve) {
    var staticIcons = iconObjs.filter(function (iconObj) {
      return !iconObj.themeable && !iconObj.deprecated;
    });
